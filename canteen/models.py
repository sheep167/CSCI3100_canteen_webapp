...
class Users:
    def __init__(self, email, password, username, at_canteen=None ,auth_type=2, confirmed=0, balance=0):
        ...
        self.cart = {} # menu that users collect in their cart
        self.image_path = None # profile picture path
        self.staff_of = str(at_canteen) # if the user is canteen owner, this will be the canteen name
...
# Purpose : to collect canteen data
class Canteens:
    def __init__(self, name, longitude, latitude, open_at, close_at, capacity):
        self.name = str(name) # canteen name
        self.longitude = str(longitude) # canteen location
        self.latitude = str(latitude) # canteen location
        self.open_at = str(open_at) # canteen opening time
        self.close_at = str(close_at) # canteen close time
        self.capacity = int(capacity) # canteen capacity
...
# Purpose : to collect Comment data
class Comments:
    def __init__(self, posted_time, posted_by_user, posted_at_canteen, rating, paragraph):
        ...
        self.rating = rating # score out of 5
        self.paragraph = paragraph  # comment text
...
# Purpose : to collect set data of each canteen 
class Set:
    def __init__(self, name, at_canteen):
        self.name = str(name) # set name
        self.at_canteen = at_canteen  # ObjectId
...
# Purpose : to collect type data of each canteen 
class Type:
    def __init__(self, name, at_canteen):
